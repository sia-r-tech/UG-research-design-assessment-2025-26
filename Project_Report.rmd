...
Second, I would recommend documenting your variables more clearly. An option would be to add a README or a codebook that answers questions like: how were variables calculated, how did you handle missing data, which participants were excluded? After this, you can add a short file that gives instructions on how to run your code, making it easier to follow your workflow.

It is good that you specify the software environments and packages you used for the analysis and include the specific versions and parameters. However, instead of simply adding figures and brief notes as linked supplementary material, you could go into more detail on how you used each package (e.g., syntax for ITT) in a separate ‘instructions’ document and add which packages are required as an appendix.

These changes would make it easier for others to follow your pipeline, perform the same analysis steps, and get the same results.
